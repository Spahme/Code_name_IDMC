...
public class Partie {
     ...
     */
        ...
        // ── Démarrag
        /**
         * Démarre la partie si toutes les conditions sont remplies : - Le
         * plateau est initialisé - Chaque équipe a au moins 2 joueurs - Chaque
         * équipe a exactement 1 maître espion
         */
     ...
     * @param mot
         */
        public void donnerIndice(String mot, int nombre, boolean estEnCours) {
            if (!estEnCours) {
        ...
        /**
         * Un opératif joue une carte. Retourne true si l'équipe peut continuer
         * à jouer, false sinon.
     * @param contenu
     * @return 
         */
        public boolean jouerCarte(String contenu, boolean estEnCours) {
            if (!estEnCours) {
                System.out.println("La partie n'est pas encore démarrée.");
                return false;
            }
        ...
        public boolean isEstEnCours(boolean estEnCours) {
            return estEnCours;
        }

        public String toString(boolean estEnCours) {
            return estEnCours
